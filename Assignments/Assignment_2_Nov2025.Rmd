...
# remember the course pre-work encouraged pre-installing these. If you haven't done that or would like to install others the command is install.packages(c("ISLR2", "factoextra", "cluster", "topicmodels"))
library(tidyverse)
library(ISLR2)
library(cluster)
library(factoextra)
